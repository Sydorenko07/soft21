...
$("threshold").addEventListener("change", () => { thresholdDirty = true; rememberDraft("threshold", DRAFT_THRESHOLD); });
$("refresh_seconds").addEventListener("input", () => { refreshDirty = true; rememberDraft("refresh_seconds", DRAFT_REFRESH); });
$("refresh_seconds").addEventListener("change", () => { refreshDirty = true; rememberDraft("refresh_seconds", DRAFT_REFRESH); });
